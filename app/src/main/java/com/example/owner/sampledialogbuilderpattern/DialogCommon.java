...
import com.example.owner.sampledialogbuilderpattern.databinding.DialogCommonBinding;
...
public class DialogCommon extends Dialog {
    ...
    public DialogCommon(Builder builder) {
    ...
    public static class Builder {
        ...
        public DialogCommon build() {
            return new DialogCommon(this);
        }

    }

    interface DialogListener {
        void onClickListener(DialogCommon dialogCommon);
    }
}
